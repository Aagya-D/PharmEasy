      ...
      <header className="bg-white border-b border-gray-200 px-6 py-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">Export data and review operational summary</p>
          </div>
          <button
      ...
      <main className="p-6">
        ...
        {loading && !stats && (
          <div className="flex flex-col items-center justify-center py-24 text-gray-500">
            ...
            <p className="text-sm text-gray-400 mt-1">Preparing your reports</p>
          </div>
        )}
          ...
          <>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100">
              <div className="p-6 border-b border-gray-100">
                ...
                <p className="text-sm text-gray-500 mt-1">Download your business data as CSV files for accounting and analysis</p>
              </div>
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="border border-gray-200 rounded-xl p-6 hover:border-blue-300 hover:shadow-md transition-all">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-gray-900 text-base">Export Inventory</h3>
                ...
                {/* Export Sales Card */}
                <div className="border border-gray-200 rounded-xl p-6 hover:border-emerald-300 hover:shadow-md transition-all">
                  <div className="flex items-start gap-4">
                    <div className="p-3 bg-emerald-50 rounded-xl flex-shrink-0">
                      <DollarSign size={28} className="text-emerald-600" />
                    </div>
                    <div className="flex-1">
                      <h3 className="font-semibold text-gray-900 text-base">Export Sales</h3>
                      <p className="text-sm text-gray-500 mt-1 mb-4">
            ...
            <div className="mt-8 bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="p-4 bg-gray-50 rounded-xl">
                  ...
                  <p className="text-xl font-bold text-gray-900 mt-1">{stats.pendingOrders || 0}</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-xl">
