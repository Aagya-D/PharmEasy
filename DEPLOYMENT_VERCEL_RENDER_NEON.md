...
3. Add env vars from [Frontend/.env.example](Frontend/.env.example):
   ...
   - `VITE_SOCKET_URL=https://<your-render-service>.onrender.com` (optional but recommended)
4. Deploy.
...
- `CORS_ORIGIN=https://<your-vercel-domain>,https://<your-custom-domain>`
- `CORS_ORIGIN_PATTERNS=https://<your-vercel-project>-*.vercel.app` (optional for preview deployments)
